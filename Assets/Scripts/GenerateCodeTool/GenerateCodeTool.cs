...
namespace XLuaDemo
{
    public class GenerateCodeTool : MonoBehaviour
    {
        ...
        [InlineProperty] [HorizontalGroup("Group2", LabelWidth = 70)]
        ...
        [InlineButton("GeneratePrefab", "生成预制体")] [LabelText("预制体路径")] [FolderPath]
        ...
        private void GeneratePrefab()
        {
            ...
            else
            {
                ...
                bool success;
                UnityEditor.PrefabUtility.SaveAsPrefabAssetAndConnect(gameObject, prefabPath, UnityEditor.InteractionMode.AutomatedAction);
        ...
        [FolderPath] [LabelText("生成代码路径")] public string m_GenerateCodePath;


        [LabelText("文件夹")] [HorizontalGroup("Group1", LabelWidth = 50)]
        public string m_Folder;

        [LabelText("类名")] [HorizontalGroup("Group1", LabelWidth = 50)]
        public string m_ClassName;

        [NonSerialized] public string prefabPath;
        
        
        [TableList] public List<BindUIComponent> m_AllComponents;

        public string ScriptGenerateFilePath
        {
            get { return $"{m_GenerateCodePath}/{m_Folder}/{m_ClassName + "Generate"}.lua"; }
        }

        public string ScriptFilePath
        {
            get { return $"{m_GenerateCodePath}/{m_Folder}/{m_ClassName}.lua"; }
        }
    ...
    {
        [TableColumnWidth(30)] public string m_FildName;

        [TableColumnWidth(30)] public GameObject m_Obj;

        [TableColumnWidth(30)] public Component m_Component;

        [NonSerialized] public string nodePath;
